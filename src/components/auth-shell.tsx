...
/**
 * Moldura das telas publicas de autenticacao (login, esqueci senha, redefinir
 * senha). Mantem o mesmo split-screen em todas - o cartao branco central e' o
 * unico ponto que muda.
 */
    ...
    <div className="grid min-h-screen grid-cols-1 md:grid-cols-2">
      <div className="relative flex flex-col items-center justify-between py-10 px-8 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-sm">
          <div className="bg-white rounded-3xl shadow-2xl px-8 py-10">{children}</div>
        </div>
