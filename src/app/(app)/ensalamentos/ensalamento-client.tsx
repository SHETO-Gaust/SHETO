...
export function EnsalamentoClient({ initialTurmas, escolaId, dependencies }: Props) {
                ...
                <div key={group.serie.id}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {group.turmas.map(turma => {
                            const totalComponentes = turma.serie.componentes.filter(c => c.aulas_semanais > 0).length;
