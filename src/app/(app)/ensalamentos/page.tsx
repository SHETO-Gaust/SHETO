...
export default async function EnsalamentoPage() {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Por favor, selecione uma escola no menu superior para gerenciar as turmas e o ensalamento.
          </CardDescription>
        </CardHeader>
      </Card>
    );
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
            <CardTitle>Turmas e Ensalamento</CardTitle>
            <CardDescription>
