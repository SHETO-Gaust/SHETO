  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 h-[calc(100vh-64px)] overflow-y-hidden flex flex-col">
      <div className="flex items-center justify-between space-y-2 shrink-0">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-[#1e1e2f]">Refino de Horário</h2>
      ...
      <div className="flex-1 min-h-0 bg-white/50 backdrop-blur-sm border rounded-xl shadow-sm p-4 overflow-y-auto">
